import { defineComponent, ref, onMounted, watch, onBeforeUnmount, shallowReadonly, shallowReactive, shallowRef } from "vue";
    ...
    setup(props) {
        ...
        watch(() => props.code, v => {
            ...
            if (v !== model.getValue()) {
                ...
                // pushEditOperations says it expects cursorComputer, but doesn't seem to need one,.....
